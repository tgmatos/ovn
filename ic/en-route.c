...
static void route_clear_tracked(struct ed_type_route *data);
...
static void
route_clear_tracked(struct ed_type_route *data)
{
    struct ed_type_route *pb_data = data;
    struct route_tracked *tr_data;
